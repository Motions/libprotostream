...
struct magic_value {
  ...
  * constexpr
  * method
  *  of the Derived subclass. It is required to avoid clashes with the One
  * Definition Rule
  ...
  * means that
  *        the deriving class may have a different base (magic_value<...>) in
  * every translation
  *        unit, because the address of the string literal may vary. Although
  * this code
  *        will probably behave correctly nevertheless, the standard declares
  * the behaviour
  *        undefined.
  */
