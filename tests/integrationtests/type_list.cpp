...
static_assert(std::is_same<concat<std::tuple<int, unsigned>, std::tuple<int, int>,
                                  std::tuple<>>::type<std::tuple>,
...
static_assert(
    std::is_same<product<std::tuple<int, unsigned>, std::tuple<float, double>>::type<std::tuple>,
                 std::tuple<wrapper<int, float>, wrapper<int, double>, wrapper<unsigned, float>,
