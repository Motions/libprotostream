...
HStream* protostream_open_new(const char* path, uint32_t frames_per_kf, const void* proto_header,
...
void protostream_append_keyframe(HStream* stream, const void* keyframe,
...
void protostream_get_keyframe(HKeyframeIterator* iterator, const void** into,
