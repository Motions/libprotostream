...
using mmap_writer = stream<with_backend<mmap_backend<file_mode_t::READ_APPEND>>,
...
using stream_writer = stream<with_backend<posix_file_backend<file_mode_t::READ_APPEND>>,
